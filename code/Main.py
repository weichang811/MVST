...
if __name__ == '__main__':
    ...
    parser.add_argument('-city', '--city', type=str, help='Specify city', choices=['SF','crime','tianque'], default='crime')
    ...
    if params['city'] == 'NYC':
        ...
        #params['C_inc'] = ['安全生产','城市管理','工商监管','交通安全','金融监管','困难救助','老龄殡葬','矛盾纠纷','农林水利','扫黄打非','生态环境','食药安全','卫生健康','文教体育','消防安全','信访维稳','疫情防控','优抚安置','治安隐患','治危拆违','质量监管','自然灾害','其他']
        params['C_inc'] = ['安全生产','城市管理','工商监管','交通安全','金融监管']
        params['C'] = len(params['C_inc'])
        #params['H'], params['W'] = (127, 1)
        params['H'], params['W'] = (10, 10)
        params['time_slice'] = 4
        start, end = (2018, 5), (2020, 8)   
    elif params['city'] == 'crime':
        #params['C_inc'] = ['安全生产','城市管理','工商监管','交通安全','金融监管','困难救助','老龄殡葬','矛盾纠纷','农林水利','扫黄打非','生态环境','食药安全','卫生健康','文教体育','消防安全','信访维稳','疫情防控','优抚安置','治安隐患','治危拆违','质量监管','自然灾害','其他']
        #params['C_inc'] = ['安全生产']
        params['C_inc'] = ['安全生产','城市管理','工商监管','交通安全','金融监管']
        params['C'] = len(params['C_inc'])
        #params['H'], params['W'] = (127, 1)
        params['H'], params['W'] = (77, 1)
        params['time_slice'] = 4
        start, end = (2018, 5), (2020, 8)   
    elif params['city'] == 'tianque':
        #params['C_inc'] = ['安全生产','城市管理','工商监管','交通安全','金融监管','困难救助','老龄殡葬','矛盾纠纷','农林水利','扫黄打非','生态环境','食药安全','卫生健康','文教体育','消防安全','信访维稳','疫情防控','优抚安置','治安隐患','治危拆违','质量监管','自然灾害','其他']
        #params['C_inc'] = ['安全生产','城市管理','工商监管','交通安全','金融监管']
        params['C_inc'] = ['城市管理']
        params['C'] = len(params['C_inc'])
    ...
    data_dir = os.path.join(params['input_dir'], f'crime-chi-12.npz')
    print(data_dir)
    ...
    #data_loader,data_loader_trip = data_generator.get_data_loader(params=params, data=data)
    ...
    if not params['test_only']:
        trainer.train(data_loader=data_loader,
                      #data_loader_trip=data_loader_trip,
